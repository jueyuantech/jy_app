...
struct lv_fs_drv_t {
    ...
    lv_fs_res_t (*remove_cb)(lv_fs_drv_t * drv, const char * path);
 ...
 * @param path      path beginning with the driver letter (e.g. A:/path/to/file)
 * @return          LV_FS_RES_OK on success; LV_FS_RES_NOT_IMP if driver not supported; other lv_fs_res_t on error
 */
