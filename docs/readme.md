<div align="center">
  ...
  <p><strong>Firmware Application Layer for Smart Glasses</strong></p>
...
- Load the `.7z` firmware package, refresh serial ports.
- Use the panel log, progress bar, and `Retry` / `Interrupt` buttons to monitor or recover the flow; click `About->Help` to view the full instructions.
